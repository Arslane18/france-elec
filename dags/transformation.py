...
def data_transformation():
    ...
    build_silver = SparkSubmitOperator(
        ...
        application_args=["--eco2mix-path", ECO2MIX_DATA_PATH, "--openmeteo-path", WEATHER_DATA_PATH, "--output-dir", ECO2MIX_WEATHER_DATA_PATH, "--holiday-path", HOLIDAY_PATH, "--staging-dir", ECO2MIX_WEATHER_STAGING_PATH],
    ...
    build_silver >> load_snowflake >> construct_gold_layer()
