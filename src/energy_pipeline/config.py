...
REGION_COORDS = {
    ...
    27 : (47.3220, 5.0415),         # Dijon
    28 : (49.4944, 0.1079),         # Le Havre
    32 : (50.6292, 3.0573),         # Lille
    44 : (48.5734, 7.7521),         # Strasbourg
    52 : (47.2184, -1.5536),        # Nantes
    53 : (48.1173, -1.6778),        # Rennes
    75 : (44.8378, -0.5792),        # Bordeaux
    76 : (43.6047, 1.4442),         # Toulouse
    84 : (45.7640, 4.8357),         # Lyon
    93 : (43.2965, 5.3698),         # Marseille
}
